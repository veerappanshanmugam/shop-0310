...
Generated at: 2026-03-11T03:13:03.335073+00:00
Project: shop-0310
Milestone: 2
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/categories",
        "method": "GET",
        "description": "List all categories, returns array (may be empty on fresh DB)",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "endpoint": "/products",
        "method": "POST",
        "description": "Attempt to create a product with a category_id that does not exist",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/products/{product_id}",
        "method": "GET",
        "description": "Attempt to get a product with an ID that does not exist",
        "request_data": {
            "path": {
                "product_id": 999999
            },
    ...
    },
    {
        ...
        "endpoint": "/products",
        "method": "GET",
        "description": "List all products, returns array (may be empty on fresh DB)",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
