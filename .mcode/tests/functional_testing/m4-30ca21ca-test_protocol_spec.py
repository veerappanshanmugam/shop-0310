...
Generated at: 2026-03-11T03:33:03.989573+00:00
Project: shop-0310
Milestone: 4
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/orders",
        "method": "POST",
        "description": "Attempt to create an order with missing required fields, expect 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {}
    ...
    },
    {
        ...
        "endpoint": "/orders/{order_id}",
        "method": "GET",
        "description": "Attempt to retrieve an order that does not exist, expect 404",
        "request_data": {
            "path": {
                "order_id": 999999
            },
    ...
    {
        "name": "create_order_invalid_type",
        "category": "INVALID_TYPE",
        "endpoint": "/orders",
        "method": "POST",
        "description": "Attempt to create an order with invalid data types (string user_id), expect 422",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
