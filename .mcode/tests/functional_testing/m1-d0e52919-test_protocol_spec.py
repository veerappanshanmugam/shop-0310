...
Generated at: 2026-03-11T03:06:40.752463+00:00
Project: shop-0310
Milestone: 1
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/",
        "method": "GET",
        "description": "Verify health check endpoint returns healthy status and service name",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "POST",
        "description": "Create a new user with valid email and name, expect 200 with user data returned",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "POST",
        "description": "Attempt to create a user with an email that already exists, expect 400 with detail message",
        "setup": {
            "endpoint": "/users",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create a user then retrieve it by ID, expect 200 with matching user data",
        "setup": {
            "endpoint": "/users",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/users/{user_id}",
        "method": "GET",
        "description": "Request a user with a non-existent ID, expect 404 with detail message",
        "setup": null,
        "request_data": {
            "path": {
                "user_id": 999999
    ...
    {
        "name": "get_user_invalid_id_type",
        "category": "INVALID_TYPE",
        "endpoint": "/users/{user_id}",
        "method": "GET",
        "description": "Request a user with a non-integer ID string, expect 422 validation error",
        "setup": null,
        "request_data": {
            "path": {
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "GET",
        "description": "List all users, expect 200 with an array response",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "GET",
        "description": "Create a user then list all users, expect 200 with at least one user in the array",
        "setup": {
            "endpoint": "/users",
            "method": "POST",
            "body": {
