...
Generated at: 2026-03-11T03:23:33.824963+00:00
Project: shop-0310
Milestone: 5
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    {
        "name": "sales_report_response_structure",
        "category": "HAPPY_PATH",
        "endpoint": "/reports/sales",
        "method": "GET",
        "description": "Sales report returns all required fields: total_revenue, total_orders, average_order_value, pending_orders, completed_orders",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Inventory report on empty database returns all zeros with default threshold",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "inventory_report_zero_threshold",
        "category": "BOUNDARY",
        "endpoint": "/reports/inventory",
        "method": "GET",
        "description": "Inventory report with low_stock_threshold=0 boundary value",
        "request_data": {
            "path": {},
            "query": {
    ...
    {
        "name": "categories_report_with_category",
        "category": "HAPPY_PATH",
        "endpoint": "/reports/categories",
        "method": "GET",
        "description": "Category performance report includes a newly created category with zero revenue and units sold",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
        ...
        "setup": {
            ...
            "body": {
                ...
                "description": "Category created for reports testing"
            },
            "extract_id_from": "id"
        },
        "cleanup": null
    ...
    {
        "name": "users_report_with_user",
        "category": "HAPPY_PATH",
        "endpoint": "/reports/users",
        "method": "GET",
        "description": "User activity report includes a newly created user with total_orders=0 and total_spent=0",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "inventory_report_large_threshold",
        "category": "BOUNDARY",
        "endpoint": "/reports/inventory",
        "method": "GET",
        "description": "Inventory report with a very large low_stock_threshold to count all products as low stock",
        "request_data": {
            "path": {},
            "query": {
