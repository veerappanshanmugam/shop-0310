...
Generated at: 2026-03-11T03:14:34.429794+00:00
Project: shop-0310
Milestone: 3
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "method": "GET",
        "description": "Create a product (which auto-creates inventory), then retrieve inventory by product_id",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/inventory/{product_id}",
        "method": "GET",
        "description": "Attempt to get inventory for a non-existent product_id, expect 404",
        "setup": null,
        "request_data": {
            "path": {
                "product_id": 999999
    ...
    },
    {
        ...
        "endpoint": "/inventory/{product_id}",
        "method": "PUT",
        "description": "Attempt to update inventory for a non-existent product_id, expect 404",
        "setup": null,
        "request_data": {
            "path": {
                "product_id": 999999
    ...
    },
    {
        ...
        "endpoint": "/inventory/{product_id}",
        "method": "PUT",
        "description": "Attempt to update inventory without required quantity field, expect 422 validation error",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
                "name": "Missing Field Widget",
                "description": "Product for missing field test",
                "price": 9.99
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "setup": {
            ...
            "method": "POST",
            "body": {
                "name": "Reserve Test Widget",
                "description": "Product for reserve test",
                "price": 49.99
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "endpoint": "/inventory/{product_id}/reserve",
        "method": "POST",
        "description": "Create a product (inventory starts at 0), attempt to reserve 5 units which exceeds available stock, expect 400",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/inventory/{product_id}/reserve",
        "method": "POST",
        "description": "Attempt to reserve inventory for a non-existent product_id, expect 404",
        "setup": null,
        "request_data": {
            "path": {
                "product_id": 999999
    ...
    },
    {
        ...
        "endpoint": "/inventory/{product_id}/reserve",
        "method": "POST",
        "description": "Attempt to reserve inventory without required quantity field, expect 422 validation error",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
                "name": "Missing Reserve Widget",
                "description": "Product for missing field reserve test",
                "price": 5.99
            },
            "extract_id_from": "id"
        },
